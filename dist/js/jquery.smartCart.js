        ...
        _setToolbar: function () {
            ...
            if (this.options.toolbarSettings.showCheckoutButton) {
                ...
                switch (this.options.toolbarSettings.checkoutButtonStyle) {
                    case 'paypal':
                        btnCheckout = '<button class="sc-button-checkout-paypal sc-cart-checkout" type="submit"><img src="https://www.paypalobjects.com/webstatic/mktg/merchant_portal/button/buynow.es.png" alt="Check out with PayPal" /></button>';
                        break;
                    case 'image':
